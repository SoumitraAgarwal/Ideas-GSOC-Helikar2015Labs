ccNetViz = function(canvas, options) {
    ...
    this.set = function(nodes, edges, layout) {
        ...
        scene.nodes.set(gl, nodes, options.styles, textures, function(v, e, i)  {
            var x = e.x;
            var y = e.y;
        ...
        scene.edges.set(gl, edges, options.styles, textures, function(v, e, i)  {
            var s = e.source;
            var t = e.target;
    ...
    this.draw = function() {
        window.requestAnimationFrame(function()  {
            ...
            scene.elements.forEach(function(e)  {return e.draw(transform, width, height);});
        });
    }
